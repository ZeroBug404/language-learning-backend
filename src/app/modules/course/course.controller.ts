...
// const assignInstructors = catchAsync(async (req: Request, res: Response) => {
//   const { id } = req.params;
...
//     statusCode: httpStatus.OK,
//     success: true,
//     message: 'Course instructors assigned successfully',
//     data: result,
//   });
// });

// const removeInstructors = catchAsync(async (req: Request, res: Response) => {
//   const { id } = req.params;
//   console.log(req.body.faculties);
...
//     statusCode: httpStatus.OK,
//     success: true,
//     message: 'Course instructors deleted successfully',
//     data: result,
//   });
// });
